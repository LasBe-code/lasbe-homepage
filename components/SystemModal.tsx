...
export default function SystemModal() {
  ...
  return (
    <div className="flex flex-col gap-8 justify-center items-center w-[300px] h-[400px] p-4 backdrop-blur-2xl bg-white/30">
      ...
      <div className="flex flex-col items-center">
        ...
        <p className="text-xs opacity-50">2024년 10월 개발</p>
      </div>
